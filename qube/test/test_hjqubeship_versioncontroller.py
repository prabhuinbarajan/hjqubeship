...
HELLO_VERSION = "/v1/hjqubeship/version"
...
class TesthjqubeshipVersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_hjqubeship_default_version(self, *args, **kwargs):
    ...
    def test_hjqubeship_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
