...
from qube.src.api.hjqubeshipcontroller import hjqubeshipController
from qube.src.api.hjqubeshipcontroller import hjqubeshipItemController
from qube.src.api.versioncontroller import hjqubeshipItemVersionController
...
api.add_resource(hjqubeshipItemVersionController, '/v1/hjqubeship/version')
api.add_resource(hjqubeshipController, '/v1/hjqubeship')
api.add_resource(hjqubeshipItemController, '/v1/hjqubeship/<string:entity_id>')
